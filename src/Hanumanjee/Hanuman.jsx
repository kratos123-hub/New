...
import './Hanumanjee.module.css';
import Timer from '../Timer/Timer';
import HanumanTimer from './HanumanjeeTimer';
    ...
    <div>
      <div className="container">
        <div className="info-row">
          <div className="text">
            <h1 className='h1'>Shri Lete Hue Hanuman Ji</h1>
            {/* <h1></h1> */}
          </div>
          <HanumanTimer />  
        </div>
        ...
        <div className="section1">
          ...
          <div className="image-left">
            ...
            <img
              src="/Assets/Lete Hue Hanuman Ji/expense.jpeg"
              alt="Progress Graph"
          ...
          <div className="image-right">
            ...
            <img
              src="/Assets/Lete Hue Hanuman Ji/Manpower.jpeg"
        ...
        <div className="section2"> */}
          <div className="image-right">
            ...
            <img
              src="/Assets/Lete Hue Hanuman Ji/MUOT.jpeg"
              alt="Pile Progress Till 22 September"
              className="graph-image-uniform img2"
              width="350px"
            />
          ...
          <div className="image-left">
            ...
            <img
              src="/Assets/Lete Hue Hanuman Ji/rcb.jpeg"
          ...
          <div className="image-left">
            ...
            <img
              src="/Assets/Lete Hue Hanuman Ji/ehpru.jpeg"
              alt="Cost Breakdown Graph"
              className="graph-image-uniform img4"
              width="350px"
            />
      ...
      <div className="container2">
        ...
        <div className="pdf">
          <a href="/Assets/SLH Report.pdf" target="_blank">Preview PDF</a>
          <a href="/Assets/SLH Report.pdf" download>Download PDF</a>
        </div>
      </div>
    </div>
  );
